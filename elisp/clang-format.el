...
is a zero-based file offset, assuming â€˜utf-8-unixâ€™ coding."
...
;; â€˜bufferpos-to-fileposâ€™ and â€˜filepos-to-bufferposâ€™ are new in Emacs 25.1.
...
uses the function `buffer-file-name'."
  ...
  (let ((file-start (clang-format--bufferpos-to-filepos start 'approximate
        ...
        ;; always use â€˜utf-8-unixâ€™ and ignore the buffer coding system.
